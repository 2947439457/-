	...
	<div id="content" class="xgrid">
		...
		<p>
			<div style="float:left;">
				<button class="btn-icon btn-plus" onClick="location='sys_emp_add.ftl';"><span></span>添加员工</button>
			</div>
			...
			<table class="data display datatable">
					...
					<#list syEmp as emp>
						<tr class="odd gradeX">
                            ...
                            <td>${emp.remark}</td>
                            <td class="center">
                                <button class="btn-icon btn-small btn-blue btn-star" onClick="location='sys_emp_add.ftl';"><span></span>修改</button>
