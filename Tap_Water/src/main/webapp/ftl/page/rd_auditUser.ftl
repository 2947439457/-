...
//审核操作
function auditMutil(){
	showWindow({url:'../page/rd_audit_progress.ftl',width:560,height:240});
}
function audit(){
	showWindow({url:'../page/rd_audit_progress1.ftl',width:560,height:240});
}
