...
<div id="wrapper">
	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<p><button class="btn-icon btn-plus" onClick="location='sys_waterType_add.html';"><span></span>添加用水类型</button></p>
			...
			<table class="data display">
					...
					<#list syCosttypes as costtypes>
						<tr class="odd">
                            ...
                            <td class="center">
                                <button class="btn-icon btn-small btn-blue btn-star" onClick="location='sys_waterType_add.ftl';"><span></span>修改</button>
