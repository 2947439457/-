	...
	<div id="content" class="xgrid">
		...
		<p>
			<div style="float:left;">
				<button class="btn-icon btn-star" onClick="location='sys_areapower_set.ftl';"><span></span>批量设置片区权限</button>
			</div>
			...
			<table class="data display">
				...
				<#list syEmp as emp>
						<tr class="odd gradeX">
                            ...
                            <td>${emp.remark}</td>
                            <td class="center">
                                <button class="btn-icon btn-small btn-blue btn-star" onClick="location='sys_areapower_set.ftl';"><span></span>设置片区权限</button>                            </td>
                        </tr>
				</#list>
					<#--<tr class="odd gradeX">-->
