		...
		<div class="x12">
			...
			<h2>
				...
				<div style="float:right;">
					按表册复核
					<a href="rd_auditUser.ftl">按用户复核</a>
				</div>
			</h2>
...
//审核操作
function auditMutil(){
	showWindow({url:'../page/rd_audit_progress.html',width:560,height:240});
}
function audit(){
	showWindow({url:'../page/rd_audit_progress1.html',width:560,height:240});
}
